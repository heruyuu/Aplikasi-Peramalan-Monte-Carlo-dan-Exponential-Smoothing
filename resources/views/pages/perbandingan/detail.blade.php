        ...
        <div class="nest">
            ...
            <div class="body-nest">
                ...
                <form class="form-horizontal" id="data_form">
                    ...
                    <div id="container" style="min-width: 310px;border-top:1px solid #ccc;padding-top:10px"></div>
...
$('#data_form').on('submit', function(event) {
    ...
    $.ajax({
        ...
        success	:function(data) {
            var hasil_monte_carlo = data.data.monte_carlo.hasil_simulasi;
            var hasil_single_exponential_smoothing = data.data.single_exponential_smoothing.hasil_simulasi
            ...
            var tabel_montecarlo = "<h4>METODE MONTE CARLO</h4><table class='table table-striped table-bordered'>"+ 
                    "<tr>"+
                        ...
                        "<td>Acak</td>"+
                    "</tr>";
            $.each(data.data.monte_carlo.montecarlo, function (key, item)  {
            ...
            tabel_montecarlo = tabel_montecarlo+"<tr><td>SUM</td><td>"+data.data.monte_carlo.sum_penjualan+"</td><td colspan='4'></td></tr></table>";
            ...
            var tabel_ses = "<h4>METODE SINGLE EXPONENTIAL SMOOTHING</h4><table class='table table-striped table-bordered'>"+ 
                "<tr>"+
                    ...
                    "<td>Error^2</td>"+
                "</tr>";
            $.each(data.data.single_exponential_smoothing.forecast, function (key, item)  {
            ...
            tabel_ses = tabel_ses+"<tr><td colspan='4'>Jumlah</td><td>"+data.data.single_exponential_smoothing.sum_erorr2+"</td></tr>"+
                    "<tr><td colspan='4'>Tingkat Prediksi Kesalahan ( RMSE )</td><td>"+data.data.single_exponential_smoothing.rmse+"</td></tr></table>";
            ...
            $("#table_hasil").html("<div class='row'>"+

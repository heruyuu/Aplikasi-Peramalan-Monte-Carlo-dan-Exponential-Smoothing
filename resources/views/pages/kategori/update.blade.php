...
<div class="row">
    <div class="col-sm-12">
        <div class="nest">
            <div class="title-alt"><h6>Ubah Kategori</h6></div>
            ...
            <div class="body-nest">
                ...
                <form class="form-horizontal" id="data_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control" name="kategori" id="kategori" value="{{$data->kategori}}" placeholder="Kategori">
                        </div>
                    </div>
...
$('#data_form').on('submit', function(event) {
    ...
    $.ajax({
        type	: "POST",
        dataType: "json",
        url		: "{{asset('kategori/update/'.$data->id)}}",
        data	: idata,
        processData: false,
        contentType: false,
        cache 	: false,

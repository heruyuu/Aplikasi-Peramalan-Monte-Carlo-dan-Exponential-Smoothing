...
<div class="row">
    <div id="paper-top">
        ...
        <div class="col-sm-2">
            <div class="btn-group btn-wigdet pull-right"><a href="{{asset('kategori/tambah')}}" class="btn btn-info"><span class="entypo-plus-squared"></span> Tambah </a></div>
        </div>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-sm-12">
        <div class="nest">
            <div class="title-alt"><h6>Detail Kategori</h6></div>

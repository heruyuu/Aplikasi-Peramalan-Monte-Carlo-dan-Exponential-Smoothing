...
<div class="row">
    <div class="col-sm-12">
        <div class="nest">
            <div class="title-alt"><h6>Tambah Customer</h6></div>
            ...
            <div class="body-nest">
                ...
                <form class="form-horizontal" id="data_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="nm_customer" id="nm_customer" placeholder="Nama Customer">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="cp" id="cp" placeholder="Contact Person">
                        </div>
                    </div>
